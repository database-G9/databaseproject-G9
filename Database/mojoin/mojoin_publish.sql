...
CREATE TABLE `publish` (
  ...
  `Name` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`pIndex`),
  UNIQUE KEY `pIndex_UNIQUE` (`pIndex`)
...
INSERT INTO `publish` VALUES (1,'FireLink Studio'),(2,'三日月書版\r'),(3,'作者授權\r'),(4,'吾里文化\r'),(5,'飛燕文創\r'),(6,'原創星球\r'),(7,'恐怖喜劇\r'),(8,'華星娛樂\r'),(9,'獨家原創\r');
